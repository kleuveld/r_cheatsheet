...
I've saved the cleaned variable as a new object, so I don't overwrite anything.
In the [final .Rmd file](#cleaning-rmd), 
I will merge this back into the cleaned data.
This way, my cleaned data only contains data I expicitly select.
This keeps useless clutters to a minimum,
making my analysis data file easy to understand for my co-workers.
...
Let's say we have a bunch of related variables, such as expenditures on input:
