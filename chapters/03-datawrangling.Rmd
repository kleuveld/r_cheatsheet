...
Do not that this is very flexible, but it can be EXTREMLY slow.
If you have a large dataset, `rowSums()`and `rowMeans()` are fast and may just be
what you need.
...
If you need to do this to many columns (wich is likely),
it is worth creating a [function](#functions):
