...
But before doing anything, I make sure the `-99`s in the `age` variables are treated 
...
- You can also combine `across()` with `summarize()` to summarize multiple variables more easily.
