...
diagnosis %>%
  ...
  dplyr::select(rho, bias = estimate, estimator) %>%
...
Clearly, the more selection is correlated to education, the higher the bias in the regular model.
...
Our design can pick up a treatment effect of 0.4,
