...
a correlation of `rho` with the residual of the regression above, ensuring that
selection is affected by unobservable factors that are correlated to the outcome.
...
custom_match <- function(data, equation, outcome = "Y", term = "Z") {
  ...
  lm_robust(Y ~ Z, clusters = village, data = matched_df, weights = weights) %>%
    tidy() %>%
