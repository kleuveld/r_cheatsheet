...
However, there is an up-front cost in setting up things,
so make sure everything works before you get too busy with actual work!
...
One way to do this is to use RStudio's Project feature. 
...
Something like onedrive, teams of dropbox is difficult, 
as some folder created by renv should not be shared with co-workers.
...
- The lock file `renv.lock`, which logs all the pacakges and their versions.
- The renv folder, which contains the project pacakge library.
