...
These plot specifications can get quite complicated;
if you need to re-use it many times throughout a report, 
it is worth taking the time to convert them to a fucntion:

If you're writing a report that includes the same type of plot in many
places, it makes sense to make it into a [function](#functions): 
