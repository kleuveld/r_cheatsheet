...
labels, for which I use a vector I defined above.
...
Again, simply save it to workd using `save_as_docx(path = "my/file.docx")`.
...
work. `modelsummary()` gets the N etc. from the `broom::glance()` function. For
